...
#remove lowest score and find mean
mean(student1[-ind])
```
...
```
 ...
 >Q3From your analysis of the gradebook, which homework was toughest on students (i.e. obtained
