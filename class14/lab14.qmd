...
THe pathway with most significant p values is the M phase of the mitotic cell cycle as it has the lowest V value. The pathways don't match exactly but I do see some similarities. This could be due to multiple reasons like data input, specificity parameters, anotation differences when analyzing, etc. 
